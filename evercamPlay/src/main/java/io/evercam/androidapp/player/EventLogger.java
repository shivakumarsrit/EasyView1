 ...
 */
public class EventLogger implements MyExoPlayer.Listener, MyExoPlayer.InfoListener,
        MyExoPlayer.InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[MyExoPlayer.RENDERER_COUNT];
    }
