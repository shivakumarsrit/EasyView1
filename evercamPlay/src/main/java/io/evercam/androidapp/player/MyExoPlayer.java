 ...
 */
public class MyExoPlayer implements ExoPlayer.Listener, HlsSampleSource.EventListener,
        DefaultBandwidthMeter.EventListener, DebugTextViewHelper.Provider,
    ...
    public MyExoPlayer(RendererBuilder rendererBuilder) {
    ...
    public void setBackgrounded(boolean backgrounded) {
        ...
        if (backgrounded) {
            ...
            setSelectedTrack(TYPE_VIDEO, ExoPlayer.TRACK_DISABLED);
